...
a starfish; the locals just call them stars. None of the currency exchanges seem to have heard of them,
...
answer = 1310 * 358 * 352 = 165080960
'''

data_file = open('input.txt').readlines()
list_of_int1 = [int(i.strip('\n')) for i in data_file]
list_of_int2 = list(map(int, data_file))


def part1():
    for x in list_of_int1:
        for y in list_of_int1:
            if x + y == 2020:
...
def part2():
    ...
    for x in list_of_int1:
        ...
        for y in list_of_int1:
            n += 1
            for z in list_of_int1:
                n += 1
                if x + y + z == 2020:
                    print('{} * {} * {} = {} {}'.format(x, y, z, x * y * z, n))
                    # return
