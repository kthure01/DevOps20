...
# 1. hamta alla rader i filen "input.txt"
lines_in_file = open('input.txt').readlines()

for line in lines_in_file:
    # 3. hamta policy och password fran nuvarande rad,
    # vi kan se i input.txt;
    # att policy kommer innan ":" och password kommer efter ":".
    # darfor kan vi kora en `line.split(":")` for att dela upp dom var for sig.
    policy, password = line.split(':')

    # 4. skriv klart koden och los uppgiften
    # (printa ut alla passwords som ar "valid", hur manga ar det?)
